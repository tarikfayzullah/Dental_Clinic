...
DentalClinicApp.directive('ngSpinnerBar', ['$rootScope', '$state',
...
DentalClinicApp.directive('dropdownMenuHover', function () {
	return {
...
DentalClinicApp.directive('bindHtmlCompile', ['$compile', function ($compile) {
	'use strict';
	return {
		restrict: 'A',
		link: function (scope, element, attrs) {
...
DentalClinicApp.filter('trusted', ['$sce', function ($sce) {
	return function (text) {
		return $sce.trustAsHtml(text);
	};
}]);

DentalClinicApp.filter('converter', ['$filter', function ($filter) {
...
DentalClinicApp.directive('stickyTableHeader', [function () {
	return {
		restrict: 'A',
		scope: {
			active: '=active',
...
DentalClinicApp.directive('myTable', function () {
	'use strict';
			...
			var setDefault = function () {
				...
				$scope.tableData.columns.forEach(function (val, index) {
					$scope.tableDataFinal.columns[index] =
                    {
                        ...
                        'tdClass': !!val.tdClass ? val.tdClass : 'text-left',
                        'thClass': !!val.thClass ? val.thClass : 'text-left',
                    };
                });
				//
